...
def init_widgets(monitor):
    widgets_list = [
        ...
        widget.GenPollText(
            foreground=colors['color0'],
            func=lambda: subprocess.check_output(f"{os.path.expanduser('~')}/.dotfiles/configs/qtile/scripts/brightness.sh").decode("utf-8").strip(),
            update_interval=30,
            **widget_defaults,
            **light_widgets
        ),
        ...
        widget.Volume(
            foreground=colors['color0'],
            get_volume_command = f"{os.path.expanduser('~')}/.dotfiles/configs/qtile/scripts/volume.sh",
            **widget_defaults,
            **light_widgets
        ),
        widget.Sep(
        ...
        widget.GenPollText(
            foreground=colors['color15'],
            func=lambda: subprocess.check_output(f"{os.path.expanduser('~')}/.dotfiles/configs/qtile/scripts/get_updated.py").decode("utf-8").strip(),
            update_interval=30,
            **widget_defaults,
            **mid_widgets
        ),
        ...
        widget.GenPollText(
            foreground=colors['color0'],
            func=lambda: subprocess.check_output(f"{os.path.expanduser('~')}/.dotfiles/configs/qtile/scripts/power-profile.sh").decode("utf-8").strip(),
            update_interval=30,
            mouse_callbacks={
                'Button1' : lazy.spawn(f"alacritty -e {os.path.expanduser('~')}/.dotfiles/configs/qtile/scripts/power-management.sh"),
            },
            **widget_defaults,
            **light_widgets
        ),
    ...
    if qtile.core.name == "x11":
        clipboard = widget.TextBox(
            ...
            text='',
            mouse_callbacks={
                'Button1' : lazy.spawn(f"{os.path.expanduser('~')}/.dotfiles/configs/qtile/scripts/greenclip.sh"),
            },
            **light_widgets
        )
        ...
        clipboard = widget.TextBox(
            ...
            text='',
            mouse_callbacks={
                'Button1' : lazy.spawn(f"{os.path.expanduser('~')}/.dotfiles/configs/qtile/scripts/clipboard.sh"),
            },
            **light_widgets
        )
        ...
        screenshot = widget.TextBox(
            ...
            text='',
            mouse_callbacks={
                'Button1' : lazy.spawn(f"{os.path.expanduser('~')}/.dotfiles/configs/qtile/scripts/grim.sh"),
            },
            **light_widgets
        )
